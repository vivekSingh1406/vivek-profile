        ...
        <div className="contact-info">
          ...
          <div className="info-block">
            ...
            <div className="social-icons">
              <a href="https://www.linkedin.com/in/vivekSingh1406" target="_blank" rel="noreferrer">
                <FontAwesomeIcon icon={faLinkedin} className="icon" />
              </a>
              <a href="https://github.com/vivekSingh1406" target="_blank" rel="noreferrer">
                <FontAwesomeIcon icon={faGithub} className="icon" />
              </a>
              <a href="https://wa.me/919755752534" target="_blank" rel="noreferrer">
