...
import heroimg from '../herosection/virat2.jpg'
  ...
  return (
    <div className='portfolio-container' id='home'>
      <header className="header">
        <div className="logo">VS<span className="dot">.</span></div>
        ...
        <a href="/vivek_singh_bais.pdf" className="btn-cv" download>
          Download CV
        </a>
      ...
      <div className="main-content">
        <div className="left-section">
          ...
          <a href="https://wa.me/919755752534" target="_blank"
          ...
          <div className="socials">
            ...
            <div className="social-links">
              <div className="social-link">
                ...
                <a href="https://www.linkedin.com/in/vivekSingh1406"><span>Linkedin</span></a>
              </div>
               <div className="social-divider">|</div>
              <div className="social-link">
                <FontAwesomeIcon icon={faGithub}></FontAwesomeIcon>
                <a href="https://github.com/vivekSingh1406"> <span>Github</span></a>
              </div>  
              <div className="social-divider">|</div>
              <div className="social-link">
        ...
        <div className="right-section">
          <div className="info-section">
            <div className="developer">
              <p className="fullstack-label">FULL-STACK</p>
              <h1 className="titlee">Java Developer</h1>
            </div>
          </div>
